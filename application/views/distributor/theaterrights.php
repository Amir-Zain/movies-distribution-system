			...
			<div class="navbar-container content container-fluid">
				<div id="navbar-mobile" class="collapse navbar-toggleable-sm">
					...
					<ul class="nav navbar-nav float-xs-right">
						...
						<li class="dropdown dropdown-user nav-item"><a href="#" data-toggle="dropdown" class="dropdown-toggle nav-link dropdown-user-link"><span class="avatar avatar-online"><img src="<?=base_url('assets/images/avatar-s-1.png')?>" alt="avatar"><i></i></span><span class="user-name"><?php foreach($details as $value) { ?> <?=$value->distributor?> <?php } ?></span></a>
					...
					<div class="col-xs-12">
						<div class="card">
							<div class="card-header">
								<h4 class="card-title" id="basic-layout-form">Give Distribution Right To Distributor</h4>
							...
							<div class="card-body collapse in">
								<div class="card-block">
									<form class="form" method="post" action="<?=base_url('Theaterrightscntrl/insert/'.$editdetails->id)?>" enctype="multipart/form-data">
										<div class="form-body">
											<div class="row">
												<div class="col-md-12">
												...
												<div class="col-md-12">
													...
													<input type="text" id="" class="form-control" placeholder="Enter Course Name" name="theater" autocomplete="off"  readonly="yes" value="<?=$editdetails->theater?>"><?=form_error('theater')?>
													</div>
												</div>
												...
												<div class="col-md-12">
													...
													<input type="text" id="" class="form-control" placeholder="Enter Name" name="distributor" autocomplete="off"  readonly="yes"  value="<?=$editdetails->distributor?>"><?=form_error('distributors')?>
												...
												<div class="col-md-12">
												<div class="form-group">
													<label for="">Offered Money</label>
													<input type="text" id="" class="form-control" placeholder="First Name" name="tmoney" autocomplete="off"  readonly="yes" value="<?=$editdetails->auction;?>"><?=form_error('tmoney');?>
													</div>
												</div>
												...
												<div class="col-md-12">
													<div class="form-group">
													<label for="">Theater Rights</label>
													<textarea id="" rows="5" class="form-control summernote hidden" name="film_rights" placeholder="About Project" value="<?=set_value('film_rights')?>"></textarea><?=form_error('film_rights')?>
													</div>
												</div>
												</div>
