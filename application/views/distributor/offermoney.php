					...
					<div class="col-xs-12">
						<div class="card">
							<div class="card-header">
								<h4 class="card-title" id="basic-layout-form">View Available Films</h4>
							...
							<div class="card-body collapse in">
								<div class="card-block">
									<form class="form" method="post" action="<?=base_url('Offermoneycntrl/insert/'.$editdetails->id)?>" enctype="multipart/form-data">
										<div class="form-body">
											<div class="row">

												<img src="<?=base_url('upload/'.$editdetails->image)?>" width="200" height="250">
												<br><br><br>    
												<div class="col-md-12">
												<div class="form-group">
													<label for="">Film Name</label>
													<input type="text" id="" class="form-control" placeholder="First Name" name="film_name" autocomplete="off"  readonly="yes" value="<?=$editdetails->name;?>"><?=form_error('film_name');?>
													</div>
												</div>
													<div class="col-md-12">
													<div class="form-group">
													<label for="">Director Name</label>
													<input type="text" id="" class="form-control" placeholder="Enter Name" name="dname" autocomplete="off"  readonly="yes" value="<?=$editdetails->dname?>"><?=form_error('dname');?>
													</div>
												</div>
												...
												<div class="col-md-12">
													...
													<input type="text" id="" class="form-control" placeholder="Enter Course Name" name="pname" autocomplete="off"  readonly="yes" value="<?=$editdetails->pname?>"><?=form_error('pname');?>
													</div>
												</div>
												</div>
													<div class="col-md-12">
													...
													<input type="text" id="" class="form-control" placeholder="Enter Name" name="actor" autocomplete="off"  readonly="yes" value="<?=$editdetails->actor?>"><?=form_error('actor');?>
													</div>
												</div>
												</div>
													<div class="col-md-12">
													...
													<input type="text" id="" class="form-control" placeholder="Enter Name" name="actress" autocomplete="off"  readonly="yes" value="<?=$editdetails->actress?>"><?=form_error('actress');?>
													</div>
												</div>
													...
													<input type="text" id="" class="form-control" placeholder="Enter Name" name="budget" autocomplete="off"  readonly="yes" value="<?=$editdetails->budget?>"><?=form_error('budget');?>
													</div>
												</div>
													...
													<input type="text" id="" class="form-control" placeholder="Enter Name" name="genre" autocomplete="off"  readonly="yes" value="<?=$editdetails->genre?>"><?=form_error('genre');?>
													</div>
												</div>
													<div class="col-md-12">
													<div class="form-group">
													<label for="">Offer Money</label>
													<input type="text" id="" class="form-control" placeholder="Offer Money" name="auction" autocomplete="off" value="<?=set_value('auction')?>"><?=form_error('auction')?>
													</div>
												...
												<div class="col-md-12">
													...
													<input type="text" id="" class="form-control" placeholder="Enter Name" name="distributor" autocomplete="off"  readonly="yes" value="<?=$value->distributor?>"><?=form_error('distributor');?>
													<?php
												}
												?>
													</div>
												...
												<input type="hidden" name="image" value="<?=$editdetails->image?>">
