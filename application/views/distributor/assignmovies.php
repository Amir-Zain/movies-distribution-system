													...
													<table id="datatables-example" class="table table-striped table-bordered dataTable no-footer" width="100%" cellspacing="0" role="grid" aria-describedby="datatables-example_info" style="width: 100%;">
														<thead>
															<tr role="row">
																...
																<th class="sorting" tabindex="0" aria-controls="datatables-example" rowspan="1" colspan="1" aria-label="Age: activate to sort column ascending" style="width: 142px;">Distribution Money</th>
																...
																<th class="sorting" tabindex="0" aria-controls="datatables-example" rowspan="1" colspan="1" aria-label="Start date: activate to sort column ascending" style="width: 119px;">Sreen Counts</th>
														...
														<tbody>
															...
															<tr role="row" class="odd">
																...
																<a href="<?=base_url('Theaterrightscntrl/edit/'.$value->id)?>"><span style="color:#fff;" class="btn btn-primary icon-check" title="Give Rights"></span></a>
																<a href="<?=base_url('Theatersauctions/delete/'.$value->id)?>" onclick="return confirm('Are you sure want to delete this post?')"><span style="color:#fff;" class="btn btn-danger glyphicon glyphicon-trash" title="Delete post"></span></a>  
																</td>
