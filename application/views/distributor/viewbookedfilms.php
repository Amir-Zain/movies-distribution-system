				...
				<div id="navbar-mobile" class="collapse navbar-toggleable-sm">
					...
					<ul class="nav navbar-nav float-xs-right">
						<?php foreach ($details1 as $value)
		                  {
			              ?>
						<li class="dropdown dropdown-user nav-item"><a href="#" data-toggle="dropdown" class="dropdown-toggle nav-link dropdown-user-link"><span class="avatar avatar-online"><img src="<?=base_url('assets/images/avatar-s-1.png')?>" alt="avatar"><i></i></span><span class="user-name"><?=$value->distributor?></span></a>
							<?php
					}
						?>
						<div class="dropdown-menu dropdown-menu-right">
						<a href="<?=base_url('Dlogincntrl/logout')?>" class="dropdown-item"><i class="icon-power3"></i> Logout</a>
						</div>
						</li>
					</ul>
				</div>
	...
	<div data-scroll-to-active="true" class="main-menu menu-fixed menu-light menu-accordion menu-shadow">
		...
		<div class="main-menu-content">
			<ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
					...
					<li class=" nav-item"><a href="<?=base_url('Dhomecntrl')?>"><i class="icon-home3"></i><span data-i18n="nav.dash.main" class="menu-title">Home</span></a>
				</li>

				<li class=" nav-item"><a href="<?=base_url('Dviewcntrl')?>"><i class="icon-file-text"></i><span data-i18n="nav.bootstrap_tables.table_basic" class="menu-title">Distributor Details</span></a>
				</li>


				<li class=" nav-item"><a href="<?=base_url('Dviewfilmcntrl')?>"><i class="icon-bullhorn"></i><span data-i18n="nav.components.main" class="menu-title">View Available Films</span></a></li>

				<li class=" nav-item"><a href="<?=base_url('Dviewbookfilms')?>"><i class="icon-toggle-on"></i><span data-i18n="nav.components.main" class="menu-title">View Booked Films</span></a></li>

				<li class=" nav-item"><a href="<?=base_url('Dregisterfilmcntrl')?>"><i class="icon-check-circle"></i><span data-i18n="nav.form_layouts.form_layout_basic" class="menu-title">Regsitered Films</span></a>
				</li>
				<li class=" nav-item"><a href="<?=base_url('Dassignmovies')?>"><i class="icon-video-camera"></i><span data-i18n="nav.components.main" class="menu-title">Assign Movie To Thaeters</span></a></li>

				<li class=" nav-item"><a href="<?=base_url('Viewwardencomplaints')?>"><i class="icon-sphere"></i><span data-i18n="nav.icons.main" class="menu-title">View The Status Of Film</span></a>
				</li>
					...
					<div class="col-xs-12">
						<div class="card">
							<div class="card-header">
								<h4 class="card-title">Available Films</h4>
