				...
				<div id="navbar-mobile" class="collapse navbar-toggleable-sm">
					...
					<ul class="nav navbar-nav float-xs-right">
						<?php foreach ($details as $value)
		                  {
			              ?>
						<li class="dropdown dropdown-user nav-item"><a href="#" data-toggle="dropdown" class="dropdown-toggle nav-link dropdown-user-link"><span class="avatar avatar-online"> <i></i></span><span class="user-name"><?=$value->distributor?></span></a>
							<?php
					}
						?>
												...
												<?php foreach ($details as $value)
		{
			?>                             
												...
												<div class="form-group">
													...
													<input type="text" id="" class="form-control" placeholder="First Name" name="distributor" autocomplete="off"  readonly="yes" value="<?=$value->distributor?>">
													</div>
												</div>
													<div class="col-md-12">
													<div class="form-group">
													<label for="">Started Year</label>
													<input type="text" id="" class="form-control" placeholder="Enter Name" name="year" autocomplete="off"  readonly="yes" value="<?=$value->year?>">
													</div>
												</div>
												...
												<div class="col-md-12">
													...
													<input type="text" id="" class="form-control" placeholder="Enter Course Name" name="country" autocomplete="off"  readonly="yes" value="<?=$value->country?>">
													</div>
												</div>
