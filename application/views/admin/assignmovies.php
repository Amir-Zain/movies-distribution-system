			...
			<div class="navbar-container content container-fluid">
				<div id="navbar-mobile" class="collapse navbar-toggleable-sm">
					...
					<ul class="nav navbar-nav float-xs-right">
						...
						<a href="<?=base_url('Alogincntrl/logout')?>" class="dropdown-item"><i class="icon-power3"></i> Logout</a>
						</div>
						</li>
					</ul>
				</div>
...
<!-- main menu-->
	<div data-scroll-to-active="true" class="main-menu menu-fixed menu-light menu-accordion menu-shadow">
		...
		<div class="main-menu-content">
			...
			<li class=" nav-item"><a href="<?=base_url('Ahomecntrl')?>"><i class="icon-home3"></i><span data-i18n="nav.dash.main" class="menu-title">Home</span></a>
				</li>


				<li class=" nav-item"><a href="<?=base_url('Assignmovies')?>"><i class="icon-equalizer"></i><span data-i18n="nav.components.main" class="menu-title">Assign Movie To Distributor</span></a></li>

				<li class=" nav-item"><a href="<?=base_url('Aviewdistributorcntrl')?>"><i class="icon-sphere"></i><span data-i18n="nav.icons.main" class="menu-title">Distributor Details</span></a>
				</li>

				<li class=" nav-item"><a href="<?=base_url('Aviewfilmscntrl')?>"><i class="icon-bullhorn2"></i><span data-i18n="nav.form_layouts.form_layout_basic" class="menu-title">Movie Details</span></a>
				</li>

				

				<li class=" nav-item"><a href="<?=base_url('Aviewproducercntrl')?>"><i class="icon-pen2"></i><span data-i18n="nav.google_charts.main" class="menu-title">Producer Details</span></a></li>

				<li class=" nav-item"><a href="<?=base_url('Aviewtheatercntrl')?>"><i class="icon-file-text"></i><span data-i18n="nav.bootstrap_tables.table_basic" class="menu-title">Registered Theater Details</span></a>
				</li>
