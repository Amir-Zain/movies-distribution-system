					...
					<div class="col-xs-12">
						<div class="card">
							<div class="card-header">
								<h4 class="card-title" id="basic-layout-form">Film Details</h4>
													...
													<table id="datatables-example" class="table table-striped table-bordered dataTable no-footer" width="100%" cellspacing="0" role="grid" aria-describedby="datatables-example_info" style="width: 100%;">
														<thead>
															<tr role="row">
																...
																<th class="sorting" tabindex="0" aria-controls="datatables-example" rowspan="1" colspan="1" aria-label="Start date: activate to sort column ascending" style="width: 119px;">Estimated Budget</th>
																...
																<th class="sorting" tabindex="0" aria-controls="datatables-example" rowspan="1" colspan="1" aria-label="Start date: activate to sort column ascending" style="width: 159px;">Offered Money</th>
																<th class="sorting" tabindex="0" aria-controls="datatables-example" rowspan="1" colspan="1" aria-label="Start date: activate to sort column ascending" style="width: 159px;">Distributor</th>
																<th class="sorting" tabindex="0" aria-controls="datatables-example" rowspan="1" colspan="1" aria-label="Start date: activate to sort column ascending" style="width: 159px;">Give Distribution Right Or Reject</th>
															</tr>
														</thead>
														<tbody>
															...
															<tr role="row" class="odd">
																	<td class="sorting_1"><?= $value->film_name?></td>
																<td><?= $value->dname?></td>
																<td><?= $value->pname?></td>
																<td><?= $value->actor?></td>
																<td><?= $value->actress?></td>
																...
																<a href="<?=base_url('Filmrightscntrl/edit/'.$value->id)?>"><span style="color:#fff;" class="btn btn-primary icon-check" title="Give Rights"></span></a>
																<a href="<?=base_url('Offermoneycntrl/delete/'.$value->id)?>" onclick="return confirm('Are you sure want to delete this post?')"><span style="color:#fff;" class="btn btn-danger glyphicon glyphicon-trash" title="Delete post"></span></a>  
																</td>
