			...
			<div class="navbar-container content container-fluid">
				<div id="navbar-mobile" class="collapse navbar-toggleable-sm">
					...
					<ul class="nav navbar-nav float-xs-right">
						<?php foreach ($details1 as $value)
		                  {
			              ?>
						<li class="dropdown dropdown-user nav-item"><a href="#" data-toggle="dropdown" class="dropdown-toggle nav-link dropdown-user-link"><span class="avatar avatar-online"><img src="<?=base_url('assets/images/avatar-s-1.png')?>" alt="avatar"><i></i></span><span class="user-name"><?=$value->name?></span></a>
							<?php
					}
						?>
						<div class="dropdown-menu dropdown-menu-right">
						<a href="<?=base_url('Plogincntrl/logout')?>" class="dropdown-item"><i class="icon-power3"></i> Logout</a>
						</div>
						</li>
					</ul>
				</div>
	...
	<div data-scroll-to-active="true" class="main-menu menu-fixed menu-light menu-accordion menu-shadow">
		...
		<div class="main-menu-content">
			<ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
					...
					<li class=" nav-item"><a href="<?=base_url('Phomecntrl')?>"><i class="icon-home3"></i><span data-i18n="nav.dash.main" class="menu-title">Home</span></a>
				</li>

				<li class=" nav-item"><a href="<?=base_url('Pviewcntrl')?>"><i class="icon-file-text"></i><span data-i18n="nav.bootstrap_tables.table_basic" class="menu-title">My Details</span></a>
				</li>

				<li class=" nav-item"><a href="<?=base_url('Addfilmcntrl')?>"><i class="icon-equalizer"></i><span data-i18n="nav.components.main" class="menu-title">Add New Film</span></a></li>

				<li class=" nav-item"><a href="<?=base_url('Passignmovies')?>"><i class="icon-video-camera"></i><span data-i18n="nav.components.main" class="menu-title">Assign Movie To Distributor</span></a></li>

				

				<li class=" nav-item"><a href="<?=base_url('Pviewcollection')?>"><i class="icon-bullhorn2"></i><span data-i18n="nav.form_layouts.form_layout_basic" class="menu-title">View Collection Of Film</span></a>
				</li>

				

				<li class=" nav-item"><a href="<?=base_url('Searchcntrl')?>"><i class="icon-pen2"></i><span data-i18n="nav.google_charts.main" class="menu-title">Send Feedback To Theater Owner</span></a></li>
			</ul>
		</div>
	...
	<div class="content-wrapper">
		<div class="content-header row">
			<div class="content-header-left col-md-6 col-xs-12 mb-1">
				<h2 class="content-header-title">Producer</h2>
			</div>
					...
					<div class="col-xs-12">
						<div class="card">
							<div class="card-header">
								<h4 class="card-title" id="basic-layout-form">Add Films</h4>
							...
							<div class="card-body collapse in">
								<div class="card-block">
									<form class="form" method="post" action="<?=base_url('Addfilmcntrl/insert')?>" enctype="multipart/form-data">
										<div class="form-body">
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
													<label for="">Film Name</label>
													<input type="text" id="" class="form-control" placeholder="Film Name" name="name" autocomplete="off" value="<?=set_value('name')?>"><?=form_error('name')?>
													</div>
												</div>
												...
												<div class="col-md-6">
													...
													<input type="mail" id="" class="form-control" placeholder="Director Name" name="dname" autocomplete="off" value="<?=set_value('dname')?>"><?=form_error('dname')?>
													</div>
												</div>
												<?php
												...
												<div class="col-md-6">
													...
													<input type="mail" id="" class="form-control" placeholder="producer Name" name="pname" autocomplete="off" value="<?=$value->name?>"><?=form_error('pname')?>
													<?php
												}
												?>
													</div>
												...
												<div class="col-md-6">
													...
													<input type="text" id="" class="form-control" placeholder="Main Actor" name="actor" autocomplete="off" value="<?=set_value('actor')?>"><?=form_error('actor')?>
													</div>
												</div>
												...
												<div class="col-md-6">
													...
													<input type="text" id="" class="form-control" placeholder="Main Actress" name="actress" autocomplete="off" value="<?=set_value('actress')?>"><?=form_error('actress')?>
													</div>
												</div>
												...
												<div class="col-md-6">
													...
													<input type="text" id="" class="form-control" placeholder="Starting Budget" name="budget" autocomplete="off" value="<?=set_value('budget')?>"><?=form_error('budget')?>
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
													<label for="">Genre Of Film</label>
													<input type="text" id="" class="form-control" placeholder="Genre Of Film" name="genre" autocomplete="off" value="<?=set_value('genre')?>"><?=form_error('genre')?>
													</div>
												</div>
												<div class="col-md-12">
												<div class="form-group">
											...
											<div class="row">
												<div class="col-sm-12" style="overflow-x: auto;">
													<table id="datatables-example" class="table table-striped table-bordered dataTable no-footer" width="100%" cellspacing="0" role="grid" aria-describedby="datatables-example_info" style="width: 100%;">
														<thead>
															<tr role="row">
																<th class="sorting_asc" tabindex="0" aria-controls="datatables-example" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 130px;">Film Name</th>
																<th class="sorting" tabindex="0" aria-controls="datatables-example" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width: 130px;">Director Name</th>
																<th class="sorting" tabindex="0" aria-controls="datatables-example" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="width: 130px;">Producer Name</th>
																<th class="sorting" tabindex="0" aria-controls="datatables-example" rowspan="1" colspan="1" aria-label="Age: activate to sort column ascending" style="width: 142px;">Main Actor</th>
																<th class="sorting" tabindex="0" aria-controls="datatables-example" rowspan="1" colspan="1" aria-label="Start date: activate to sort column ascending" style="width: 119px;">Main Actress</th>
																<th class="sorting" tabindex="0" aria-controls="datatables-example" rowspan="1" colspan="1" aria-label="Start date: activate to sort column ascending" style="width: 119px;">starting Budget</th>
																<th class="sorting" tabindex="0" aria-controls="datatables-example" rowspan="1" colspan="1" aria-label="Start date: activate to sort column ascending" style="width: 119px;">Genre Of Film</th>
																<th class="sorting" tabindex="0" aria-controls="datatables-example" rowspan="1" colspan="1" aria-label="Start date: activate to sort column ascending" style="width: 159px;">Poster Of Film</th>
															</tr>
														</thead>
														<tbody>
															...
															<tr role="row" class="odd">
																...
																<a href="<?=base_url('Addfilmcntrl/delete/'.$value->id)?>" onclick="return confirm('Are you sure want to delete this post?')"><span style="color:#fff;" class="btn btn-danger glyphicon glyphicon-trash" title="Delete post"></span></a> 
																</td>
															</tr>
															<?php
																}
