			...
			<div class="navbar-container content container-fluid">
				<div id="navbar-mobile" class="collapse navbar-toggleable-sm">
					...
					<ul class="nav navbar-nav float-xs-right">
						...
						<li class="dropdown dropdown-user nav-item"><a href="#" data-toggle="dropdown" class="dropdown-toggle nav-link dropdown-user-link"><span class="avatar avatar-online"><img src="<?=base_url('assets/images/avatar-s-1.png')?>" alt="avatar"><i></i></span><span class="user-name"><?php foreach($details as $value) { ?> <?=$value->name?> <?php } ?></span></a>
						...
						<div class="card">
							...
							<div class="card-body collapse in">
								<div class="card-block">
									<form class="form" method="post" action="<?=base_url('Filmrightscntrl/insert/'.$editdetails->id)?>" enctype="multipart/form-data">
										<div class="form-body">
											<div class="row">
												<div class="col-md-12">
												...
												<div class="form-group">
													...
													<input type="text" id="" class="form-control" placeholder="First Name" name="money" autocomplete="off"  readonly="yes" value="<?=$editdetails->auction;?>"><?=form_error('money');?>
													</div>
												</div>
												...
												<div class="col-md-12">
													<div class="form-group">
													<label for="">Distributor Rights</label>
