				...
				<div id="navbar-mobile" class="collapse navbar-toggleable-sm">
					...
					<ul class="nav navbar-nav float-xs-right">
						<?php foreach ($details as $value)
		                  {
			              ?>
						<li class="dropdown dropdown-user nav-item"><a href="#" data-toggle="dropdown" class="dropdown-toggle nav-link dropdown-user-link"><span class="avatar avatar-online"> <i></i></span><span class="user-name"><?=$value->name?></span></a>
							<?php
					}
						?>
												...
												<?php foreach ($details as $value)
		{
			?>                             
												...
												<div class="form-group">
													...
													<div class="form-group">
													<label for="">Age</label>
													<input type="text" id="" class="form-control" placeholder="Enter Name" name="fname" autocomplete="off"  readonly="yes" value="<?=$value->age?>">
													</div>
												</div>
