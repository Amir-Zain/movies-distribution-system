				...
				<div id="navbar-mobile" class="collapse navbar-toggleable-sm">
					...
					<ul class="nav navbar-nav float-xs-right">
						...
						<?php foreach ($details as $value)
		                  {
			              ?>
						<li class="dropdown dropdown-user nav-item"><a href="#" data-toggle="dropdown" class="dropdown-toggle nav-link dropdown-user-link"><span class="avatar avatar-online"><img src="<?=base_url('assets/images/avatar-s-1.png')?>" alt="avatar"><i></i></span><span class="user-name"><?=$value->theater?></span></a>
							<?php
					}
						?>
						<div class="dropdown-menu dropdown-menu-right">
						<a href="<?=base_url('Tlogincntrl/logout')?>" class="dropdown-item"><i class="icon-power3"></i> Logout</a>
						</div>
						</li>
					</ul>
				</div>
	...
	<div data-scroll-to-active="true" class="main-menu menu-fixed menu-light menu-accordion menu-shadow">
		...
		<div class="main-menu-content">
			<ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
					...
					<li class=" nav-item"><a href="<?=base_url('Thomecntrl')?>"><i class="icon-home3"></i><span data-i18n="nav.dash.main" class="menu-title">Home</span></a>
				</li>

				<li class=" nav-item"><a href="<?=base_url('Tviewcntrl')?>"><i class="icon-file-text"></i><span data-i18n="nav.bootstrap_tables.table_basic" class="menu-title">Theater Details</span></a>
				</li>

				<li class=" nav-item"><a href="<?=base_url('Tviewavailablefilms')?>"><i class="icon-align-justify"></i><span data-i18n="nav.components.main" class="menu-title">View Available Films</span></a></li>

				<li class=" nav-item"><a href="<?=base_url('Tviewbookfilms')?>"><i class="icon-toggle-on"></i><span data-i18n="nav.components.main" class="menu-title">View Booked Films</span></a></li>

				<li class=" nav-item"><a href="<?=base_url('Tregisterfilmcntrl')?>"><i class="icon-check-circle"></i><span data-i18n="nav.form_layouts.form_layout_basic" class="menu-title">Regsitered Films</span></a>
				</li>

				<li class=" nav-item"><a href="<?=base_url('Tupdtcollecntrl')?>"><i class="icon-bullhorn"></i><span data-i18n="nav.components.main" class="menu-title">Update Collection Details</span></a></li>

				<li class=" nav-item"><a href="<?=base_url('Viewwardencomplaints')?>"><i class="icon-sphere"></i><span data-i18n="nav.icons.main" class="menu-title">Add Rating Details</span></a>
				</li>

				<li class=" nav-item"><a href="<?=base_url('Viewstudentcomplaints')?>"><i class="icon-equalizer"></i><span data-i18n="nav.form_layouts.form_layout_basic" class="menu-title">Send Feedback To Producer</span></a>
				</li>
						...
						<div class="card">
							...
							<div class="card-body collapse in">
								<div class="card-block">
									<form class="form" method="post" action="<?=base_url('Theatersauction/insert/'.$editdetails->id)?>" enctype="multipart/form-data">
										<div class="form-body">
											<div class="row">
												...
												<div class="form-group">
													...
													<input type="text" id="" class="form-control" placeholder="First Name" name="film_name" autocomplete="off"  readonly="yes" value="<?=$editdetails->film_name;?>"><?=form_error('film_name');?>
													</div>
												</div>
												...
												<div class="col-md-12">
													...
													<input type="text" id="" class="form-control" placeholder="Enter Course Name" name="distributor" autocomplete="off"  readonly="yes" value="<?=$editdetails->distributor?>"><?=form_error('distributor');?>
													</div>
												
												</div>
												<div class="col-md-12">
													<div class="form-group">
													<label for="">Distribution Money</label>
													<input type="text" id="" class="form-control" placeholder="Enter Course Name" name="dmoney" autocomplete="off"  readonly="yes" value="<?=$editdetails->money?>"><?=form_error('dmoney');?>
													</div>
												</div>
												...
												<div class="col-md-12">
													...
													<input type="text" id="" class="form-control" placeholder="Enter Name" name="theater" autocomplete="off"  readonly="yes" value="<?=$value->theater?>"><?=form_error('theater');?>
													
													</div>
												</div>
												<div class="col-md-12">
													<div class="form-group">
													<label for="">Screen Count</label>
													<input type="text" id="" class="form-control" placeholder="Enter Course Name" name="scrcount" autocomplete="off"  readonly="yes" value="<?=$value->screens?>"><?=form_error('scrcount');?>
													</div>
												</div>
												<?php
											}
