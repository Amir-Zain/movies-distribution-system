	...
	<div class="content-wrapper">
		<div class="content-header row">
			<div class="content-header-left col-md-6 col-xs-12 mb-1">
				<h2 class="content-header-title">Theaters</h2>
			</div>
					...
					<div class="col-xs-12">
						<div class="card">
							<div class="card-header">
								<h4 class="card-title" id="basic-layout-form">Theaters Details</h4>
												...
												<?php foreach ($details as $value)
		{
			?>                             
												...
												<div class="form-group">
													...
													<input type="text" id="" class="form-control" placeholder="First Name" name="theater" autocomplete="off"  readonly="yes" value="<?=$value->theater?>">
													</div>
												</div>
													<div class="col-md-12">
													<div class="form-group">
													<label for="">Place</label>
													<input type="text" id="" class="form-control" placeholder="Enter Name" name="place" autocomplete="off"  readonly="yes" value="<?=$value->place?>">
													</div>
												</div>
												...
												<div class="col-md-12">
													...
													<input type="text" id="" class="form-control" placeholder="Enter Course Name" name="country" autocomplete="off"  readonly="yes" value="<?=$value->screens?>">
													</div>
												</div>
