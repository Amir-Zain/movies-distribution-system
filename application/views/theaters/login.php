...
<form action="<?=base_url('Tlogincntrl/login')?>" method="post">
<fieldset class="form-group position-relative has-icon-left mb-1">
<input type="text" class="form-control form-control-lg input-lg" id="user-name" placeholder="Your Username" name="theater" required><?=form_error('theater')?>
...
<br>
<a href="<?=('Indexcntrl')?>"><p align="center">Home</p></a>
</div>
</div>
</div>
</div>
