						...
						<div class="card">
							...
							<div class="card-body collapse in">
								<div class="card-block">
									<form class="form" method="post" action="<?=base_url('Updatecollection/insert/'.$editdetails->id)?>" enctype="multipart/form-data">
										<div class="form-body">
											<div class="row">
												...
												<div class="col-md-12">
													...
													<input type="text" id="" class="form-control" placeholder="Enter Name" name="theater" autocomplete="off"  readonly="yes" value="<?=$editdetails->theater?>"><?=form_error('theater');?>
												...
												<div class="col-md-6">
													...
													<input type="text" id="" class="form-control" placeholder="Date" name="date" autocomplete="off"><?=form_error('date');?>
													</div>
												</div>
													...
													<input type="text" id="" class="form-control" placeholder="Collection" name="collection" autocomplete="off" value="<?=set_value('collection')?>"><?=form_error('collection')?>
													</div>
